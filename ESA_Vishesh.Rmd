...
# Dependent variables
```{r}
Chi_rt1 = xtabs(~ rideable_type + member_casual, data = df)
chisq.test(Chi_rt1)
Chi_rt2 = xtabs(~ rideable_type + Total_Time, data = df)
chisq.test(Chi_rt2)
Chi_rt3 = xtabs(~ rideable_type + start_station_id , data = df)
chisq.test(Chi_rt3)
Chi_rt4 = xtabs(~ rideable_type + end_station_id , data = df)
chisq.test(Chi_rt4)
Chi_rt5 = xtabs(~ rideable_type + startingm , data = df)
chisq.test(Chi_rt5)
Chi_rt6 = xtabs(~ rideable_type + endingm , data = df)
chisq.test(Chi_rt6)
```
