...
ggplot(members_preferance, aes(x= member_casual,y = used , fill = rideable_type))+
  ...
  theme_classic()
```
While there is no huge difference between annual members in choosing classic or electric bikes, Casual members choose to use electric bikes over the classic by around 680 time. 
...
ggplot(bike, aes(days, fill = days))+
  ...
  scale_fill_brewer(palette = "Set2")+
  guides(fill="none")+
  labs(title = "Number of users in the days of the week")+
  theme_classic()
```
