...
qplot (x=Total_Time, y=start_hour, data=bike_afternoon, xlab='Start_hour', ylab='Total_time', main='scatter-plot Total_Time vs start_hour (Afternoon)') 
qplot (x=Total_Time, y=start_hour, data=bike_night, xlab='Start_hour', ylab='Total_time', main='scatter-plot Total_Time vs start_hour (Night)') 
```
