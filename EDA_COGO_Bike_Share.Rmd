...
getwd()
bike <- data.frame(read.csv("Bike_Share_Data.csv"))
...
library(ggmap)
register_google(key = "AIzaSyBgZBtqLc-nSWcLKpCjCjcG2CuuXETG_yg")
#end station
...
membership_clean <- ezids::outlierKD2 (membership, Total_Time, qqplt = TRUE)
sd(membership_clean$Total_Time)

casual_clean <- ezids::outlierKD2 (casual, Total_Time, qqplt = TRUE)
sd(casual_clean$Total_Time)
...
classic_bike_clean <- ezids::outlierKD2 (classic_bike, Total_Time, qqplt = TRUE)
sd(classic_bike_clean$Total_Time)

electric_bike_clean <- ezids::outlierKD2 (electric_bike, Total_Time, qqplt = TRUE)
sd(electric_bike_clean$Total_Time)
...
pnorm(30, mean(classic_bike_clean$Total_Time), sd(classic_bike_clean$Total_Time),lower.tail=FALSE)
print('')
print('')
print('The proportion of using electric bike more than 30mins is about：')
pnorm(30, mean(electric_bike_clean$Total_Time), sd(electric_bike_clean$Total_Time),lower.tail=FALSE)
...
pnorm(45, mean(classic_bike_clean$Total_Time), sd(classic_bike_clean$Total_Time),lower.tail=FALSE)
print('')
print('')
print('The proportion of using electric bike more than 45mins is about：')
pnorm(45, mean(electric_bike_clean$Total_Time), sd(electric_bike_clean$Total_Time),lower.tail=FALSE)
...
ttest3 <- t.test(classic_bike_clean$Total_Time)
ttest3$conf.int

ttest4 <- t.test(electric_bike_clean$Total_Time)
ttest4$conf.int
...
ttest2sample_total_time_2 <- t.test(classic_bike_clean$Total_Time, electric_bike_clean$Total_Time, mu=0, alternative = 'greater' )
