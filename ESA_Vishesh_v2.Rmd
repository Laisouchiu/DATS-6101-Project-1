...
df_rt <-subset(df_rt, Total_Time != 0)
...
Bike_Type_Logit <- glm(Rt_train_y ~ Total_Time + member_casual + start_station_id + end_station_id + startingm*days, data = Rt_train_X, family = "binomial")
