...
#the columns should be only member and casual 
#the rows should be the columns names and the number of casual or member of each
#do group by each column we are using
